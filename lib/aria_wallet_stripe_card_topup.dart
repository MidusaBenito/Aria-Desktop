...
class walletStripeCheckout extends StatefulWidget {
  const walletStripeCheckout({
    super.key,
  ...
  @override
  State<walletStripeCheckout> createState() => _walletStripeCheckoutState();
}

class _walletStripeCheckoutState extends State<walletStripeCheckout> {
  String cardNumber = '';
  String expiryDate = '';
                                  ...
                                  children: [
                                    ...
                                    ElevatedButton(
                                      ...
                                      child: Container(
                                        ...
                                        child: Text(
                                          'Add \$${widget.paidAmount} to Wallet',
                                          style: TextStyle(
                                            color: Colors.white,
                                            //fontFamily: 'halter',
                                            fontSize: 13,
                                                      ...
                                                      content: Column(
                                                        ...
                                                        children: [
                                                          Row(
                                                            children: [
                                                              Text(
                                                                  "\$${widget.paidAmount} Added to Aria Wallet Successfuly",
                                                                  style: TextStyle(
                                                                      color: Color
                                                                          .fromARGB(
                                                                              255,
                                                      ...
                                                      content: Column(
                                                        ...
                                                        children: [
                                                          Row(
                                                            children: [
                                                              Text(
                                                                  "Wallet Topup unsuccessful, please try again!",
                                                                  style: TextStyle(
                                                                      color: Colors
                                                                          .redAccent,
                                                                      fontSize:
  ...
  Future<String> payViaCardDesktop(
    ...
    final url = myurls.AriaApiEndpoints.stripeCardTopUpWallet;
